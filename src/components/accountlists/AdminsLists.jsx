...
const AdminsLists = () => {
    ...
    const finalFilteredAdmins = useSearchFilter(filteredByDate, searchTerm, ['username', 'email'])

    const sortedAdmins = finalFilteredAdmins.slice().sort((a, b) => {
        const dateA =
    ...
    return (
        <div className='acc-admin-comp'>
            <div className="bg-overlay"></div>
            <h4 className='title text-xl'> Admin Account Data </h4>

...
const ManagersLists = () => {
    ...
    const finalFilteredManagers = useSearchFilter(filteredByDate, searchTerm, [
        'username',
        'email',
    ]);

    const sortedManagers = finalFilteredManagers.slice().sort((a, b) => {
        const dateA =
    ...
    return (
        <div className='acc-manager-comp'>
            <div className="bg-overlay"></div>
            <h4 className='title text-xl'> Manager Account Data </h4>
            ...
            <div className="acc-manager-lists">
